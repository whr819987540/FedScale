...
class JobServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CLIENT_GET_UPDATED_BT_PS_CONFIG = channel.unary_unary(
                '/fedscale.JobService/CLIENT_GET_UPDATED_BT_PS_CONFIG',
                request_serializer=job__api__pb2.UpdateBTPSConfigRequest.SerializeToString,
                response_deserializer=job__api__pb2.ServerResponse.FromString,
                )
...
def add_JobServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CLIENT_GET_UPDATED_BT_PS_CONFIG': grpc.unary_unary_rpc_method_handler(
                    servicer.CLIENT_GET_UPDATED_BT_PS_CONFIG,
                    request_deserializer=job__api__pb2.UpdateBTPSConfigRequest.FromString,
                    response_serializer=job__api__pb2.ServerResponse.SerializeToString,
            ),
    }
...
class JobService(object):
    ...
    @staticmethod
    def CLIENT_GET_UPDATED_BT_PS_CONFIG(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fedscale.JobService/CLIENT_GET_UPDATED_BT_PS_CONFIG',
            job__api__pb2.UpdateBTPSConfigRequest.SerializeToString,
            job__api__pb2.ServerResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
